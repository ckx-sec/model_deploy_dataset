...
int main() {
    // --- Configuration ---
    const std::string onnx_path = "assets/ultraface-rfb-320.onnx";
    const std::string image_path = "assets/test_lite_ultraface.jpg";
    ...
    cv::imwrite("ultraface_detection_result.jpg", image);
    std::cout << "Detection result saved to ultraface_detection_result.jpg" << std::endl;
